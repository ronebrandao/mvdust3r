...
def main_demo(tmpdirname, model, device, image_size, server_name, server_port, silent=False):
    ...
    scene, outmodel, outgallery = recon_fun('demo_images', min_conf_thr, as_pointcloud, transparent_cams, cam_size, n_frame)
    
    # model_from_scene_fun(scene, min_conf_thr, as_pointcloud, transparent_cams, cam_size)
